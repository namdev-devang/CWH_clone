...
const Signup = () => {
  return (
    <>
      <div className="main w-10/12 h-screen lg:w-46 flex justify-center my-10 lg:my-24 shadow-2xl rounded-xl mx-auto ">
        ...
        <div className="w-full py-10 px-5 lg:w-1/2">
          <div className="flex flex-col items-center">
            ...
            <span className="text-xl text-blue-gray-800 font-">
            Create an Account!
            </span>
            ...
            <form className="">
                ...
                <button className="hover:bg-gray-700 bg-gray-800 font-semibold text-white px-5 py-1 rounded-md flex justify-center ">Create an account</button>
          </div>
        </div>
      </div>
    </>
